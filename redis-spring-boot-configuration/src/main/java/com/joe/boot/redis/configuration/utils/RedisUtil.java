package com.joe.boot.redis.configuration.utils;
...
public class RedisUtil {
     ...
     * @return 成功结果
     */
    public Boolean releaseLock(String key, String lockKey) {
        ...
        return Objects.equals(
                redisTemplate.execute(redisScript, Collections.singletonList(key), lockKey),
     ...
     * @return 上锁成功结果
     */
    public Boolean lock(String key, String lockKey, Long time) {
        return redisTemplate.opsForValue().setIfAbsent(key, lockKey, time, TimeUnit.SECONDS);
    }
    ...
    public boolean sHasKey(String key, Object value) {
        try {
            ...
            return Objects.nonNull(res) ? res : false;
        } catch (Exception e) {
            log.error(key, e);
            return false;
        }
